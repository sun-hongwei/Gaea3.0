...
function ReportControlEx() {
    ...
    this.createCell = function (allHeader, cellHeader, uiInfo, divWidth, divHeight, isEditor) {
        ...
        switch (cellHeader.editor.type) {
            case this.controlCommon.COMBOBOX_TYPE:
            case this.controlCommon.COMBOBOXTREE_TYPE:
                cellString += '<div id="' + editor_id + '_layout" name="' + editor_name + '_layout" class="'+cellHeader.editor.data.divClass+'" style="display:table-cell;border:0px; vertical-align:middle"><table id="' +
                    editor_id +
            ...
            case this.controlCommon.IMAGE_TYPE:
                ...
                break;
            case this.controlCommon.TEXTAREA_TYPE:
                cellString += '<div id="' + editor_id + '_layout" name="' + editor_name + '_layout" class="'+cellHeader.editor.data.divClass+'" style="table-layout:fixed;display:table-cell; border:0px; vertical-align:middle;"><table id="' + editor_id + '" name="' +
            ...
            case this.controlCommon.LISTBOX_TYPE:
                if (!Tools.isNull(data.data)) {
                    ...
                    if (!Tools.isNull(json)) {
                        cellString += '<div id="' + editor_id + '_layout" name="' + editor_name + '_layout" class="'+cellHeader.editor.data.divClass+'" style="' + tableStyle + 'display:table-cell; border:0px; vertical-align:middle;"><table id="' +
