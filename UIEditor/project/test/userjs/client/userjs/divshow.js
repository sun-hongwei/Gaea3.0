...
*/
function divshow_start(uiInfo, initdata) {
	    ControlHelp.setEvent(uiInfo, "button", "onClick", function (e, uiInfo) {
	    	alert("演示！");
	    });
}
...
*/
function divshow_getRunFlowTaskInfo(uiInfo, controlInfo, state) {
}
...
*/
function divshow__ActionExecuted(uiInfo, controlInfo, actionInfo) {
}
...
var info = getGlobalScriptInfo("divshow")
divshow_start(info.uiInfo, info.initdata);