function UploadFile() {
    ...
    this.getServerPos = function() {
        var size = -1;
        Tools.simpleTomcatSubmit("/ex/upload/getsize", { filename: this.fileObj.name }, function(data) {
    ...
    this.removeServerFile = function() {
        var isok = false;
        Tools.simpleTomcatSubmit("/ex/upload/removefile", { filename: this.fileObj.name }, function(data) {
            var info = mini.decode(data)
            isok = info.ret;
        }, undefined, undefined, false);
        return isok;
    ...
    this.start = function() {
        ...
        xhr.open('POST', Tools.getAjaxTomcatUrl('/ex/upload/uploadfile'));
