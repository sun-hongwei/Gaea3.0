...
*/
function exportreport_start(uiInfo, initdata) {
    ControlHelp.setEvent(uiInfo, "reportexcel", "onClick", function (file) {
        var report = getFrameControlObjectByName(uiInfo, "reportmain");
        report.exportToExcel("reportmain", "报表1")
    });
...
*/
function exportreport_getRunFlowTaskInfo(uiInfo, controlInfo, state) {
}
...
*/
function exportreport__ActionExecuted(uiInfo, controlInfo, actionInfo) {
}
...
var info = getGlobalScriptInfo("exportreport")
exportreport_start(info.uiInfo, info.initdata);